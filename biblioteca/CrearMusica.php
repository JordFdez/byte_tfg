  ...
  include 'includes/db_con.php';
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$stmt = $enlace->prepare("INSERT INTO canciones (titulo,imagen, archivo, idgenero, idinterprete, idusuario) VALUES(?,?,?,?,?, $id)");
					    ...
					    <div class="controls">
					      	<select  name="genero">
										<?php
										 include 'config.php';
               							include 'includes/db_con.php';
										 $consulta = "SELECT * FROM genero where idusuario=$id";
