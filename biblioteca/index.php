    ...
    <div class="container">
       ...
       <th width='15%'>Genero</th> 
        ...
        <th width='15%'>Acciones</th> 
               ...
               $consulta = "SELECT canciones.id, canciones.titulo, canciones.imagen as canimagen, canciones.archivo, genero.nombre as genero, genero.imagen as imggenero, interprete.nombre as interprete, interprete.imagen as imagen   FROM canciones, genero, interprete where canciones.idgenero = genero.id and canciones.idinterprete = interprete.id and canciones.idusuario=$id ";
